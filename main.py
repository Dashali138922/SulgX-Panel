...
# ── HTML Panel v1.1.0 (UI/UX Remastered by NERULA Style) ───────────────
...
<head>
    ...
    <style>
        /* تمام استایل‌ها از ابتدا با الهام از NERULA بازنویسی شد */
        *{margin:0;padding:0;box-sizing:border-box}
        :root{
            --bg-dark: #0b0c0e;
            --card-bg: #18191c;
        ...
        /* راست‌چین کردن پنل لاگین و دشبورد اصلی */
...
<div id="dashboard-page" class="main-content">
    ...
    <div class="dashboard-header">
        ...
        <div class="header-controls">
            <button class="btn-icon-flat" onclick="toggleTheme()"><i class="fas fa-moon"></i></button>
        </div>
    </div>
    ...
    <section class="page active" id="page-dashboard">
        <div class="stats-grid" id="statsContainer">
            <!-- استات کارت ها با جاوااسکریپت پر می شوند -->
        </div>
        <div class="content-card" style="margin-top:20px;">
            <div class="card-header">
                <span class="card-title">کارت‌های فعال</span>
                <button class="btn-outline btn-sm" onclick="showAddMo()">+ جدید</button>
            </div>
            <div class="tbl-wrap">
...
<!-- مودال‌ها -->
<div class="modal-overlay" id="mo-add" style="display:none;">
    <div class="modal-box">
        <div style="display:flex;justify-content:space-between;margin-bottom:20px;">
            <h3>ایجاد اینباند</h3>
            <button onclick="document.getElementById('mo-add').style.display='none'" class="btn-outline btn-sm">بستن</button>
        </div>
        <div class="form-group"><label>نام</label><input class="form-input" id="nl"></div>
        <div class="form-group"><label>محدودیت (GB)</label><input class="form-input" type="number" id="nv" value="0"></div>
        <button class="btn-primary" onclick="createLink()">ایجاد</button>
    </div>
</div>
